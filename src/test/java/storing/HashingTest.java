...
public class HashingTest {
    ...
    @Test
    public void testAdd() {
        assertEquals(0, hashing.add("Data1", 1955)); // Assuming 10 as the size
        assertEquals(1, hashing.add("Data2", 1963)); // Assuming 10 as the size
        assertEquals(5, hashing.add("Data3", 2008)); // Assuming 10 as the size
    }
